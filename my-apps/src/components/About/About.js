...
export default class About extends Component {
    constructor(props) {
        super(props);
        this.state = {
            wechat:"https://s2.ax1x.com/2019/09/01/np7utK.png",
            qq:"https://s2.ax1x.com/2019/09/01/np7ou9.png"
        }
    ...
    render() { 
        ...
        return ( 
            <div className="about">
                ...
                <a href="https://github.com/FelixHsp" target="_blank"><img src="https://s2.ax1x.com/2019/09/01/np7KfO.png" className="git" alt=""/></a>
